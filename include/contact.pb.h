...
inline void Contact::set_email(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_email()) {
    clear_contact_type();
    set_has_email();
    _impl_.contact_type_.email_.InitDefault();
  }
  _impl_.contact_type_.email_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& Contact::_internal_email() const {
  if (_internal_has_email()) {
    return _impl_.contact_type_.email_.Get();
  }
...
inline void Contact::_internal_set_email(const std::string& value) {
  ...
  _impl_.contact_type_.email_.Set(value, GetArenaForAllocation());
}
inline std::string* Contact::_internal_mutable_email() {
  ...
  return _impl_.contact_type_.email_.Mutable(      GetArenaForAllocation());
}
inline std::string* Contact::release_email() {
  // @@protoc_insertion_point(field_release:Contact.email)
  if (_internal_has_email()) {
    clear_has_contact_type();
    return _impl_.contact_type_.email_.Release();
  } else {
    return nullptr;
  }
}
inline void Contact::set_allocated_email(std::string* email) {
  ...
  if (email != nullptr) {
    set_has_email();
    _impl_.contact_type_.email_.InitAllocated(email, GetArenaForAllocation());
  }
...
inline void Contact::set_phone(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_phone()) {
    clear_contact_type();
    set_has_phone();
    _impl_.contact_type_.phone_.InitDefault();
  }
  _impl_.contact_type_.phone_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& Contact::_internal_phone() const {
  if (_internal_has_phone()) {
    return _impl_.contact_type_.phone_.Get();
  }
  return ::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited();
}
inline void Contact::_internal_set_phone(const std::string& value) {
  ...
  _impl_.contact_type_.phone_.Set(value, GetArenaForAllocation());
}
inline std::string* Contact::_internal_mutable_phone() {
  ...
  return _impl_.contact_type_.phone_.Mutable(      GetArenaForAllocation());
}
inline std::string* Contact::release_phone() {
  // @@protoc_insertion_point(field_release:Contact.phone)
  if (_internal_has_phone()) {
    clear_has_contact_type();
    return _impl_.contact_type_.phone_.Release();
  } else {
    return nullptr;
  }
}
inline void Contact::set_allocated_phone(std::string* phone) {
  ...
  if (phone != nullptr) {
    set_has_phone();
    _impl_.contact_type_.phone_.InitAllocated(phone, GetArenaForAllocation());
  }
...
inline Contact::ContactTypeCase Contact::contact_type_case() const {
  return Contact::ContactTypeCase(_impl_._oneof_case_[0]);
}
#ifdef __GNUC__
